...
function main() {
    return (
        <>
            <div name='portfolio' className='client rounded-3xl ml-4 md:ml-16 overflow-x-auto my-20 flex justify-center items-center pl-7 md:pl-0 flex-col'>
                <div className='flex justify-center items-center flex-col pt-16'>
                    ...
                    <div className='flex shadow-lg justify-center items-center flex-wrap gap-12 py-10 md:pl-6'>
