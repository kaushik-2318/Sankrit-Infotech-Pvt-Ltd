...
function Skill() {
    ...
    return (
        <>
            <div className='flex justify-center items-center flex-col gap-10 mx-2 mt-24 md:m-24 py-10 md:pb-20 bg-zinc-800 rounded-3xl shadow-[0px_0px_5px_5px_rgba(4,21,154,0.8)]'>
                ...
                <div className='flex justify-center items-center flex-col md:flex-row gap-20 px-7 md:px-24 w-full '>
                    <div className='trigger flex justify-center items-left flex-col w-full md:w-1/2 gap-10'>
                        {
                            progressbar.map((e) => (
                                <div className='flex justify-center items-left gap-3 flex-col'>
        ...
        <div className="relative size-40">
            <svg className="size-full" width="36" height="36" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
                ...
                <g className="origin-center -rotate-90 transform">
                    <circle cx="18" cy="18" r="16" fill="none" className="circle stroke-current text-blue-600" stroke-width="2" stroke-dasharray="100" stroke-dashoffset={`${100-props.progress}`}></circle>
                </g>
            </svg>
